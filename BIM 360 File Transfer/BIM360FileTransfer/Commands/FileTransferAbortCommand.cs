...
{
    internal class FileTransferAbortCommand : ICommand
    {
        ...
        public FileTransferAbortCommand(FileBrowseViewModel fileBrowseViewModel)
        {
        ...
        public void Execute(object parameter)
        {
            ...
            _fileBrowseViewModel.AbortTransfer();
        }
        #endregion
    }
}
