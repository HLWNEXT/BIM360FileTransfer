...
{
    internal class FileTransferExecuteCommand : ICommand
    {
        ...
        public FileTransferExecuteCommand(FileBrowseViewModel fileBrowseViewModel)
        {
        ...
        public void Execute(object parameter)
        {
            ...
            _fileBrowseViewModel.ExecuteTransfer();
        }
        #endregion
    }
}
